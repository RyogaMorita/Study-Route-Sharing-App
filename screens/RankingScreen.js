...
const styles = StyleSheet.create({
  ...
  myRankCard: { borderRadius: 16, padding: 16, alignItems: 'center', marginBottom: 16, shadowColor: '#5C6BC0', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.3, shadowRadius: 12, elevation: 6 },
  ...
  listCard: { borderRadius: 16, overflow: 'hidden', marginBottom: 32, shadowColor: '#000', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.08, shadowRadius: 8, elevation: 3 },
